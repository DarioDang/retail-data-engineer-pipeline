    ...
    if df_rating.empty:
        ...
        with leg_col1:
            st.markdown(
                ...
                "<div style='width:10px; height:10px; border-radius:50%; background:#38ef7d;'></div>"
                "<span style='color:white; font-size:11px;'>≥ 4.5 Excellent</span></div>",
                unsafe_allow_html=True
            )
        with leg_col2:
            st.markdown(
                "<div style='display:flex; align-items:center; gap:6px; justify-content:center;'>"
                "<div style='width:10px; height:10px; border-radius:50%; background:#f7971e;'></div>"
                "<span style='color:white; font-size:11px;'>≥ 4.0 Good</span></div>",
                unsafe_allow_html=True
            )
        with leg_col3:
            st.markdown(
                ...
                "<span style='color:white; font-size:11px;'>< 4.0 Fair</span></div>",
                unsafe_allow_html=True
            )
